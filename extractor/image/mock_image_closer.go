...
type ConfigInfoReturns struct {
	_a0 types.BlobInfo
}

type ConfigInfoExpectation struct {
	Returns ConfigInfoReturns
}

func (_m *MockImageCloser) ApplyConfigInfoExpectation(e ConfigInfoExpectation) {
	var args []interface{}
	_m.On("ConfigInfo", args...).Return(e.Returns._a0)
}

func (_m *MockImageCloser) ApplyConfigInfoExpectations(expectations []ConfigInfoExpectation) {
	for _, e := range expectations {
