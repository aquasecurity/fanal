...
func TestParseDpkgPkgLicenseInfo(t *testing.T) {
	var tests = map[string]struct {
		...
		"multiple_license_found_1": {
			...
			pkg: types.Package{
				Name: "liblzma5", License: "Autoconf,GPL-2,GPL-3,LGPL-2,LGPL-2.1,PD,PD-debian,config-h,noderivs,none,permissive-fsf,permissive-nowarranty,probably-PD,public domain",
			},
		},
		"multiple_license_found_2": {
			path: "./testdata/usr/share/doc/libnettle6/copyright",
			pkg: types.Package{
				Name: "libnettle6", License: "GAP,GPL,GPL-2,LGPL,LGPL-2,LGPL-2.1,other,public domain,public-domain",
			},
		},
