...
func (a bundlerLibraryAnalyzer) Analyze(filePath string, content []byte) (*analyzer.AnalysisResult, error) {
	res, err := library.Analyze(library.Bundler, filePath, content, bundler.Parse)
	if err != nil {
